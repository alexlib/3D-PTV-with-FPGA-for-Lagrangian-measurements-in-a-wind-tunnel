...
\topicFramePrimary{Why it is important to join forces and develop open-source software for science}
...
\embedvideo{\includegraphics[width=\textwidth]{fig/real_time_3dptv_snapshot.jpg}}{video/real_time_3dptv.mp4}    
\end{frame}
