...
\begin{frame}[label=ptv-4]{Let's get a quick intro to 3D-PTV}
    \centering \cardImg[height]{ptv-scheme}{.8\textwidth}
\end{frame}
...
\begin{frame}[label=ptv-9b]{We prefer multi-media non-linear calibration}
    \centering\cardImg[height=.8\textheight]{multimedia}{.7\textwidth}
\end{frame}
...
\begin{frame}[label=ptv-11]{Tracking in 2D space vs 3D space}
    \centering\cardImg[height=.8\textheight]{tracking_in_image_space_projection}{.7\textwidth}
\end{frame}


\begin{frame}[label=ptv-12]{Tracking in 2D space}
	\centering\cardImg[height=.8\textheight]{tracking_in_image_space}{.7\textwidth}
\end{frame}


\begin{frame}[label=ptv-13]{Tracking in 3D space }
	\centering\cardImg[height=.8\textheight]{tracking_in_3d_space}{.7\textwidth}
\end{frame}
