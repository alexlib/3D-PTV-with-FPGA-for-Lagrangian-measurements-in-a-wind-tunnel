...
\centering
\cardImg{fig/mr_ptv_photo}{0.5\textwidth}
...
\begin{frameImg}[height]{fig/telaviv}
\vspace*{60mm}
\begin{cardTiny}
...
\begin{frameImg}[height]{fig/open_week_tau.png}
% \vspace*{60mm}
%\begin{cardTiny}
%International students are very welcome - follow this great opportunity to visit Tel Aviv for free :) .
%\end{cardTiny}
\end{frameImg}
